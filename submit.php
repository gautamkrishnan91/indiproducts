	    			...
	    			<table border='0'>
	    				...
	    				<tr><td><label for='prod_subcat'><div class='requiredfield'>*</div>Sub Category: </label></td><td>
	    					<select id='prod_subcat' name='prod_subcat'>
		    					<option value='Biscuits' sid='1'>Biscuits</option>
		    					<option value='Chocolates' sid='1'>Chocolates</option>
		    					<option value='Coffee Shops' sid='1'>Coffee Shops</option>
		    					<option value='Confectioneries' sid='1'>Confectioneries</option>
		    					<option value='Ice Creams' sid='1'>Ice Creams</option>
		    					<option value='Pizzerias' sid='1'>Pizzerias</option>
		    					<option value='Restaurants' sid='1'>Restaurants</option>
	    					</select></td></tr>
